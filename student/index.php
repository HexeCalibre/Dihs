			...
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(../admin/images/bg-01.jpg);">
					<span class="login100-form-title-1">
						Dasma Integrated National Highschool | Student Panel
					</span>
				</div>
				...
				<form class="login100-form validate-form" method="post" id="loginForm">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input class="input100" type="text" name="studentidno" placeholder="Enter Student ID Number" autocomplete="off">
