<?php
session_start();
$sectionName = $_SESSION["sectionname-add"];
...
<body>
  ...
  <div class="container">
    <div class="pull-right">
      <button type="button" class="btn btn-primary btn-addall">Add All Students</button>
      <a href="sections.php"><button type="button" class="btn btn-warning">Go Back</button></a>
    </div>
  ...
  <script src="../js/admin/addstudtosec.js"></script>
</body>
</html>